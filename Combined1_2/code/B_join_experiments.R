...
tax_exp1 <- merge(otu_exp1, map_exp1, by = 0, all = FALSE, all.x = TRUE)
tax_exp1$Row.names <- NULL
tax_exp1 <- tax_exp1 |> tidyr::unite(Kingdom:Genus, col = "taxa", sep = ";")
tax_exp1$Species <- NULL
tax_exp1 <- tax_exp1 |>
  group_by(taxa) |>
...
# Experiment 2 data has not yet undergone same filtering as E1 data
